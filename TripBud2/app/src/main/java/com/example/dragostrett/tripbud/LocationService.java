...
/**
 * Created by DragosTrett on 31.05.2017.
 */
...
public class LocationService extends Service {
    ...
    public void onCreate() {
        ...
        Toast.makeText(MainActivity.context, "Location Service1",
    ...
    public void onStart(Intent intent, int startId) {
        Toast.makeText(MainActivity.context, "Location Service2",
                Toast.LENGTH_SHORT).show();
        locationManager = (LocationManager) getSystemService(Context.LOCATION_SERVICE);
        listener = new MyLocationListener();
        locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 4000, 0, listener);
    ...
    protected boolean isBetterLocation(Location location, Location currentBestLocation) {
        ...
        Toast.makeText(MainActivity.context, "Location Service3",
                Toast.LENGTH_SHORT).show();
    ...
    public class MyLocationListener implements LocationListener
    {
        ...
        {
            Toast.makeText(MainActivity.context, "Location Service",
                    Toast.LENGTH_SHORT).show();
